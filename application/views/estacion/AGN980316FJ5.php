  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url();?>estaciones" data-toggle="" data-target="" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <?php 
                  ...
                  while ($row = $resultado->fetch_object()) { 
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-4">
                      <a class="nav-link" href="<?php echo $id; ?>" data-toggle="" data-target="" aria-expanded="true" aria-controls="collapseTwo">
                      <div class="card border-left-primary shadow h-100 py-2" id="">
                        <div class="card-body">
                          <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><?php echo ($row->nestacion); ?></div>
                              <div class="h5 mb-0 font-weight-bold text-gray-800"> <?php echo ($row->pl); ?> </div>
                            </div>
